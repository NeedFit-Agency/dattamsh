...
const contentChapter2: LessonContent[]  = [
  { 
    ...
    audioSrc: '/audio/21_intro_computer.mp3ng to learn about different types of computers. Computers come in many shapes and sizes, from big to small! Let\'s explore the different kinds of computers we use in our daily lives.',
