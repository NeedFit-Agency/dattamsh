...
export default function LearningPage() {
  ...
  const handleContinue = () => {
        ...
        else { console.log("Lesson Finished!"); router.push('/'); } // Go home or to results
    };
  ...
  if (currentSlideIndex === totalSlides - 1 && (currentContent.type !== 'drag-drop' || dndChecked)) { continueButtonText = "Finish Lesson"; }
