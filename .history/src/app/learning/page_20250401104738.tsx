...
export default function LearningPage() {
  ...
  const handleConfirmExit = () => {
    router.push(`/learn/${standardId}/chapter/${chapterId}`);
  };
  ...
  const handleContinue = () => {
    if (currentSlide < totalSlides - 1) {
      ...
      router.push(`/quiz?standard=${standardId}&chapter=${chapterId}&lesson=${lessonId}`);
    }
  };
        ...
        <div className={styles.glassPanel}>
          <div className={styles.letterShowcase}>
            {["</>", "🤖", "🔒", "☁️", "📝"].map((symbol, index) => (
              <div 
                key={index}
                className={`${styles.letterItem} ${index === currentSlide ? styles.letterItemActive : ''}`}
        ...
        <div className={styles.topBar}>
          <div className={styles.navigationControls}>
            ...
            <div className={styles.lessonIndicator}>
              Standard {standardId}, Chapter {chapterId}, Lesson {lessonId}
            </div>
          </div>
          <StatsBar streak={3} gems={175} hearts={hearts} />
        </div>
              ...
              <div className={styles.leftColumn}>
                {currentContent.image ? (
                  <div className={styles.techImageContainer}>
                    <img 
                      src={`/images/${currentContent.image}`} 
                ...
                <div className={styles.explanationBox}>
                  <div className={styles.mascotContainer}>
                    ...
                    <div className={styles.mascot}>
                      <img 
                        src="/images/owl-bird.png" 
                        alt="Tech Learning Owl" 
          ...
          <div className={styles.glassPanel}>
            <div className={styles.progressIndicator}>
              {learningContent.map((_, index) => (
                <div 
                  key={index} 
                  className={`${styles.progressPill} ${index === currentSlide ? styles.progressPillActive : ''} ${index < currentSlide ? styles.progressPillCompleted : ''}`}
                  onClick={() => index <= currentSlide && setCurrentSlide(index)}
                >
                  {index + 1}
                </div>
