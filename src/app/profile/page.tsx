          ...
          <main className={styles.contentArea}>
            <div className={styles.profileHeader}>
              ...
              <div className={styles.profileStats}>
                <StatsBox variant="streak" icon={faFire} value={userData.streak} subtext="Day Streak" />
                <StatsBox variant="xp" icon={faGem} value={userData.gems} subtext="Gems" />
                <StatsBox variant="accuracy" icon={faHeart} value={userData.hearts} subtext="Hearts" />
              </div>
